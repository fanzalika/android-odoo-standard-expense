...
public class OColumn {
    ...
    private HashMap<String, String> mReadOnlyMap = new HashMap<>();
    ...
    public OColumn addReadOnlyRule(String key,String value){
        mReadOnlyMap.put(key,value);
        return this;
    }
    public HashMap<String,String> getmReadOnlyMap(){
        return mReadOnlyMap;
    }
}
